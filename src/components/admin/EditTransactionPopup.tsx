      ...
      <DialogContent className="bg-[#1C1C1C] border-neutral-800 text-white">
        ...
        <form onSubmit={handleSubmit} className="space-y-6 pt-4">
            <div className="grid grid-cols-2 gap-4">
                <div className="grid gap-2"><Label htmlFor="date">Date (dd/mm/yyyy)</Label><Input id="date" name="date" value={data.date} onChange={handleChange} className={inputStyles} /></div>
